...
namespace Calculator
{
    public class Parser
    {
        ...
        public IExpression ParseExpression(ParsletPrecedence precedence)
        {
            Token token = Consume();
    ...
    {
        public BantamParser(Lexer lexer) : base((IEnumerable<Token>)lexer)
        {
        ...
        Prefix(TokenType.TILDE, ParsletPrecedence.PREFIX);
        Prefix(TokenType.BANG, ParsletPrecedence.PREFIX);

        // For kicks, we'll make "!" both prefix and postfix, kind of like ++.
        Postfix(TokenType.BANG, ParsletPrecedence.POSTFIX);
     ...
     * precedence.
     */
    public void Postfix(TokenType token, ParsletPrecedence precedence)
    {
